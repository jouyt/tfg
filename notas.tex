...
\begin{enumerate} % Para crear listas numeradas
\item CABEZA
\begin{itemize} % Para crear listas sin numerar
\item Cara % Salen por defecto con puntos, pero se podrían cambiar por guiones o cualquier cosa de esta forma:\item [-]
...
\end{itemize} % Para terminar la lista

\item CUELLO
\end{enumerate} % Para terminar la lista numerada

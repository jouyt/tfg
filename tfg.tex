...
\usepackage[top=2.5cm, left=3.8cm, bottom=2.5cm, right=2.8cm]{geometry} % Para los márgenes
...
\usepackage{url}
\urlstyle{same}
\usepackage[colorlinks=true, linkcolor=blue, citecolor=red, linktoc=page, breaklinks=true]{hyperref} % Para poner links
\usepackage{float}

...
\begin{titlepage}
\begin{figure}[ht!]
	\includegraphics[width=0.40\textwidth]{logo-ehu.jpg}
\end{figure}
\begin{figure}[ht!]
\vspace*{-3cm}
	%\includegraphics[width=0.40\textwidth]{logo-escuela.jpg}
	\includegraphics[width=0.40\textwidth,right=\linewidth]{logo-escuela.jpg}
\end{figure}
\vskip 15em
\begin{center}
\begin{Huge}
...
\vskip 2em
Anatomía de superficie: su representación píctorica y escultórica en la muerte de Cristo
\end{Huge}
\vskip 15em
\begin{Large}
Nerea González Cordero
\vskip 0.75em
Leioa, \today
\end{Large}
\end{center}\par
